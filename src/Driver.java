			...
			while(choice!=0){
				...
				while(choice!=1 && choice!= 2  && choice!= 3  && choice!= 4 && choice!=0 && choice != 5){
					...
					if(choice==1){
						...
						ArrayList<String> categoryList = (ArrayList<String>) Search.findCategories(recipeList); // get list of all used categories
						...
						ArrayList<String> ingredientList = (ArrayList<String>) Search.findIngredients(recipeList); // get list of all used categories
